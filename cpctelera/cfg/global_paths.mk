...
AT2PLAYERS_PATH := $(CPCT_PATH)tools/arkosTracker-2.0.0/players/
AT2TOOLS_PATH := $(CPCT_PATH)tools/arkosTracker-2.0.0/tools/
...
SONG2AKM := $(AT2TOOLS_PATH)SongToAkm
SONG2SFX := $(AT2TOOLS_PATH)SongToSoundEffects
DISARK   := $(AT2TOOLS_PATH)Disark
RASM     := $(AT2TOOLS_PATH)rasm
